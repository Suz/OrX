Notes on OrX program: 

Originally written by SR Kiihne, 24-02-2004

Oriented MAS nmr spectra
=======================================
I originally tested this on spectra from Bruker experiments: jr0203 #22-26
...
At the matlab or octave prompt, type `edit OR_inputs`.
...
__Note:__
This code was used to produce simulations and fitting results published in Raap, J.,; Hollander, J.; Ovchinnikova, T. V.; Swischeva, N. V.; Skladnev, D.; & Kiihne, S.; _Trans and surface membrane bound zervamicin IIB: C-13-MAOSS-NMR at high spinning speed_; __Journal of Biomolecular NMR__ (2006) 35: 285-93.
